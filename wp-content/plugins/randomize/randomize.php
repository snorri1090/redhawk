...
Author URI: http://vollknorke.de

Copyright 2016  Sebastian Schwarz (email : mail@sebastianschwarz.me)
...
class randomize extends WP_Widget {
	...
	function __construct() {
	  $widget_ops = array('classname' => 'randomize',
                      'description' => ' Displays randomized text from the selected category.');
		parent::__construct( 
			'randomize',
			'Randomize', 
			$widget_ops
